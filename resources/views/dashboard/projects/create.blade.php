<x-app-layout>
    <x-dashnav/>
    <form action="{{route('aprojects.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="overflow-hidden shadow sm:rounded-md">
            <div class="bg-white px-4 py-5 sm:p-6">
                <div class="flex mb-4">
                    <h2 class="font-medium font-mont text-nightblue text-base uppercase">New Project Informations</h2>
                </div>
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="date" name="event_date" id="event_date" autocomplete="email"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-nightblue focus:ring-nightblue sm:text-sm">
                    </div>

                    <div class="col-span-6">
                        <label for="volunteers" class="block text-sm font-medium text-gray-700">Volunteer</label>
                    ...
                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                        ...
                        <input type="text" name="link" id="link" autocomplete="address-level1"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-nightblue focus:ring-nightblue sm:text-sm">
                    </div>
                </div>
            </div>

<x-app-layout>
    <x-dashnav/>
    <form action="{{route('volunteerExperiences.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="overflow-hidden shadow sm:rounded-md">
            <div class="bg-white px-4 py-5 sm:p-6">
                <div class="flex mb-4">
                    <h2 class="font-medium font-mont text-nightblue text-base uppercase">New Experience Informations</h2>
                </div>

<x-app-layout>
    <x-dashnav/>
    <form action="{{route('apublications.update',$publication->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="category" name="category" autocomplete="category-name"
                            ...
                            <option value="Article" @if ($publication->category == 'Article') selected @endif>Article</option>
                            <option value="Chapter" @if ($publication->category == 'Chapter') selected @endif>Chapter</option>
                            <option value="Conference Paper" @if ($publication->category == 'Conference Paper') selected @endif>Conference Paper</option>
                        </select>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="journal" id="journal" autocomplete="family-name"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-nightblue focus:ring-nightblue sm:text-sm" value="{{$publication->journal}}">
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        <label for="title" class="block text-sm font-medium text-gray-700">Title</label>
                        <textarea id="title" name="title" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-nightblue focus:ring-nightblue sm:text-sm" placeholder="you@example.com">{{$publication->title}}</textarea>
                    </div>
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text" name="authors" id="authors"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-nightblue focus:ring-nightblue sm:text-sm" value="{{$publication->authors}}">
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                        ...
                        <input type="text" name="doi" id="doi" autocomplete="address-level1"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-nightblue focus:ring-nightblue sm:text-sm" value="{{$publication->doi}}">
                    </div>
                </div>
            </div>
